...
export BASH_IT="/home/jimmy/.config/bash_it"
...
source /home/jimmy/.config/broot/launcher/bash/br
. "$HOME/.cargo/env"
...
```dataview
LIST FROM [[Bash - Bash Profile]] AND -"CHANGELOG" AND -"04-RESOURCES/Code/Bash/Bash - Bash Profile"
```
